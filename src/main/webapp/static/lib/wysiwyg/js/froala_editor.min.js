...
!function (a) {
    ...
    var b = function (c, d) {
        ...
        this.$original_element.on("froala.doInit", a.proxy(function () {
            ...
            var b;
            if (this.opts.initOnClick)b = this.load(a.FroalaEditor.MODULES, this), this.tearUp(b, this), this.$el.on("mousedown.init dragenter.init focus.init", a.proxy(function (c) {
    ...
    b.DEFAULTS = {initOnClick: !1}, b.MODULES = {}, b.PLUGINS = {}, b.VERSION = "2.0.0", b.INSTANCES = [], b.ID = 0, b.prototype._init = function () {
        ...
        if ("string" == typeof c) {
            ...
            return this.each(function () {
                ...
                if (!e)return a.error("Editor should be initialized before calling the " + c + " method.");
                var g, h;
    ...
    a.extend(a.FroalaEditor.DEFAULTS, {
        ...
        function h(c) {
            ...
            if (b.opts.htmlAllowComments || c.nodeType != Node.COMMENT_NODE)if (c.tagName && c.tagName.match(s))c.parentNode.removeChild(c); else if (c.tagName && !c.tagName.match(r))c.outerHTML = c.innerHTML; else {
                var f = c.attributes;
    ...
    a.FroalaEditor.COMMANDS = {
        ...
        undo: {title: "Undo", undo: !1, forcedRefresh: !0},
        redo: {title: "Redo", undo: !1, forcedRefresh: !0},
        insertHR: {title: "Insert Horizontal Line", undo: !0},
        clearFormatting: {title: "Clear Formatting", undo: !0},
    ...
    a.FroalaEditor.NO_DELETE_TAGS = ["TH", "TD", "TABLE"], a.FroalaEditor.SIMPLE_ENTER_TAGS = ["TH", "TD", "LI"], a.FroalaEditor.MODULES.cursor = function (b) {
        ...
        function h(c) {
            ...
            if (null !== e) {
                ...
                if (b.node.isBlock(e) && h && a.FroalaEditor.NO_DELETE_TAGS.indexOf(h.tagName) < 0)if (b.node.isBlock(h))if (b.node.isEmpty(h) && !b.node.isList(h))a(h).remove(); else {
        ...
        function k(c) {
            ...
            if (null !== e) {
                ...
                if (b.node.isBlock(e) && h && a.FroalaEditor.NO_DELETE_TAGS.indexOf(h.tagName) < 0)if (b.node.isBlock(h))if (b.node.isList(h))if (b.node.isEmpty(e, !0))a(e).remove(), a(h).find("li:first").prepend(a.FroalaEditor.MARKERS); else {
        ...
        function l(d) {
            ...
            var h;
            if (b.node.isBlock(e)) {
                if (a.FroalaEditor.NO_DELETE_TAGS.indexOf(e.tagName) < 0)if (b.node.isList(e))d.previousSibling ? (a(e).find("li:first").prepend(d), b.cursorLists._backspace(d)) : (a(e).find("li:first").prepend(a.FroalaEditor.MARKERS), a(d).remove()); else if (h = b.node.contents(e), h && "BR" == h[0].tagName && a(h[0]).remove(), h && "BLOCKQUOTE" == e.tagName) {
                    var i = h[0];
                ...
                for (h = b.node.contents(e); e.nodeType != Node.TEXT_NODE && h.length && !a(e).is("[contenteditable='false']");)e = h[0], h = b.node.contents(e);
    ...
    a.FroalaEditor.INVISIBLE_SPACE = "&#8203;", a.FroalaEditor.START_MARKER = '<span class="fr-marker" data-id="0" data-type="true" style="display: none; line-height: 0;">' + a.FroalaEditor.INVISIBLE_SPACE + "</span>", a.FroalaEditor.END_MARKER = '<span class="fr-marker" data-id="0" data-type="false" style="display: none; line-height: 0;">' + a.FroalaEditor.INVISIBLE_SPACE + "</span>", a.FroalaEditor.MARKERS = a.FroalaEditor.START_MARKER + a.FroalaEditor.END_MARKER, a.FroalaEditor.MODULES.markers = function (b) {
        ...
        function e() {
            ...
            try {
                ...
                if (c.insertNode(d), d = b.$el.find("span.fr-marker").get(0)) {
                    for (var e = d.nextSibling; e && e.nodeType === Node.TEXT_NODE && 0 === e.textContent.length;)a(e).remove(), e = b.$el.find("span.fr-marker").get(0).nextSibling;
                    return d
                }
                return null
            } catch (f) {
    ...
    a.FroalaEditor.XS = 0, a.FroalaEditor.SM = 1, a.FroalaEditor.MD = 2, a.FroalaEditor.LG = 3, a.FroalaEditor.MODULES.helpers = function (b) {
        ...
        function d() {
            ...
            if (c() > 0)a.msie = !0; else {
                var b = navigator.userAgent.toLowerCase(), d = /(chrome)[ \/]([\w.]+)/.exec(b) || /(webkit)[ \/]([\w.]+)/.exec(b) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(b) || /(msie) ([\w.]+)/.exec(b) || b.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(b) || [], e = {
                    browser: d[1] || "",
                    version: d[2] || "0"
                };
    ...
    a.FroalaEditor.UNICODE_NBSP = String.fromCharCode(160), a.FroalaEditor.VOID_ELEMENTS = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"], a.FroalaEditor.BLOCK_TAGS = ["p", "div", "h1", "h2", "h3", "h4", "h5", "h6", "pre", "blockquote", "ul", "ol", "li", "table", "td", "th", "thead", "tfoot", "tbody", "tr", "hr"], a.extend(a.FroalaEditor.DEFAULTS, {
        ...
        function g() {
            ...
            var d;
            do d = b.$el.find("*:empty").not(c.join(", ") + ", .fr-marker"), d.remove(), d = b.$el.find("*:empty").not(c.join(", ") + ", .fr-marker"); while (d.length)
        }
        ...
        function n(c) {
            if ("undefined" == typeof c && (c = b.$el.get(0)), c.nodeType == Node.ELEMENT_NODE)for (var d = b.node.contents(c), e = d.length - 1; e >= 0; e--)a(d[e]).hasClass("fr-marker") || n(d[e]); else if (c.nodeType == Node.TEXT_NODE && c.textContent.length > 0) {
                var f = c.previousSibling, g = c.nextSibling;
                if (b.node.isBlock(f) && b.node.isBlock(g) && 0 === c.textContent.trim().length)a(c).remove(); else {
                    var h = c.textContent;
        ...
        function A(c, d) {
            ...
            var e;
            if (e = d ? c : b.clean.html(c), c.indexOf('class="fr-marker"') < 0 && (e = y(e)), b.core.isEmpty())b.$el.html(e); else {
                b.markers.insert();
                var f, g = b.$el.find(".fr-marker").get(0);
                if (x(e) && (f = b.node.deepestParent(g)))if (b.node.isBlock(f) && b.node.isEmpty(f))a(f).replaceWith(e); else {
                    var h = g, i = "", j = "";
    ...
    a.FroalaEditor.ENTER_P = 0, a.FroalaEditor.ENTER_DIV = 1, a.FroalaEditor.ENTER_BR = 2, a.FroalaEditor.KEYCODE = {
        ...
        function l(c) {
            for (var d = 0; d < c.length; d++)c[d].nodeType == Node.TEXT_NODE && /\u200B/gi.test(c[d].textContent) ? (c[d].textContent = c[d].textContent.replace(/\u200B/gi, ""), 0 === c[d].textContent.length && a(c[d]).remove()) : c[d].nodeType == Node.ELEMENT_NODE && "IFRAME" != c[d].nodeType && l(b.node.contents(c[d]))
        }
        ...
        function n(c) {
            ...
            (c.which == a.FroalaEditor.KEYCODE.ENTER || c.which == a.FroalaEditor.KEYCODE.BACKSPACE) && m();
            ...
            j(k) && 0 === a(k).find("li").length && !a(k).hasClass("fr-marker") && "IFRAME" != k.tagName && (b.selection.save(), l(b.node.contents(k)), b.selection.restore())
        }
        ...
        function q(c, d) {
            ...
            return i.append(g), g.data("container", i), t[c] = g, b.button.bindCommands(g, !1), a(b.original_window).on("resize.popups" + b.id, function () {
                ...
                if (a.FroalaEditor.KEYCODE.ENTER == e)g.find(".fr-submit:visible").length > 0 && (d.preventDefault(), d.stopPropagation(), b.events.disableBlur(), b.button.exec(g.find(".fr-submit:visible:first"))); else {
                    if (a.FroalaEditor.KEYCODE.ESC == e)return d.preventDefault(), d.stopPropagation(), b.$el.find(".fr-marker") && (b.events.disableBlur(), a(this).data("skip", !0), b.events.focus(), b.selection.restore(), b.events.enableBlur()), f(c) && g.find(".fr-back:visible").length ? b.button.exec(g.find(".fr-back:visible:first")) : h(c), b.opts.toolbarInline && b.toolbar.showInline(null, !0), !1;
                    d.stopPropagation()
                }
    ...
    a.FroalaEditor.MODULES.refresh = function (b) {
        ...
        function g(c) {
            for (var d = "rtl" == b.opts.direction ? "margin-right" : "margin-left", e = b.selection.blocks(), f = 0; f < e.length; f++) {
                ...
                if (b.helpers.getPX(a(e[f]).css(d)) > 0)return c.removeClass("fr-disabled"), !0
            }
    ...
    a.extend(a.FroalaEditor.DEFAULTS, {
        ...
        function e(c, d) {
            b.helpers.isMobile() ? b.toolbar.show() : setTimeout(function () {
                if (c && c.which == a.FroalaEditor.KEYCODE.ESC); else if (b.selection.inEditor() && b.core.hasFocus() && !b.popups.areVisible() && (b.opts.toolbarVisibleWithoutSelection || "" !== b.selection.text() || d)) {
