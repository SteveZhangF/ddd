...
!function (a) {
    ...
    a.extend(a.FroalaEditor.POPUP_TEMPLATES, {
        ...
        function p() {
            ...
            if (c.length > 0)if (0 === a.find("tbody tr").length)n(); else if (c.remove(), b.$el.find(".fr-selected-cell").length > 0)d(); else {
            ...
            if (null == c && b.$el.find(".fr-selected-cell").length > 0 && (c = b.$el.find(".fr-selected-cell").closest("table")), c) {
                ...
                return e.find("tr").not(e.find("table tr")).each(function (b, c) {
                    ...
                    e.find("> th, > td").each(function (c, e) {
                        for (var g = a(e), h = parseInt(g.attr("colspan"), 10) || 1, i = parseInt(g.attr("rowspan"), 10) || 1, j = b; b + i > j; j++)for (var k = f; f + h > k; k++)d[j] || (d[j] = []), d[j][k] ? f++ : d[j][k] = e;
                        f += h
                    })
                }), d
            }
        ...
        function G(b, c, d, e, f) {
            ...
            for (g = k; l >= g; g++)((parseInt(a(f[g][m]).attr("rowspan"), 10) || 1) > 1 || (parseInt(a(f[g][m]).attr("colspan"), 10) || 1) > 1) && (i = B(f[g][m], f), j = C(i.row, i.col, f), k = Math.min(i.row, k), l = Math.max(j.row, l), m = Math.min(i.col, m), n = Math.max(j.col, n)), ((parseInt(a(f[g][n]).attr("rowspan"), 10) || 1) > 1 || (parseInt(a(f[g][n]).attr("colspan"), 10) || 1) > 1) && (i = B(f[g][n], f), j = C(i.row, i.col, f), k = Math.min(i.row, k), l = Math.max(j.row, l), m = Math.min(i.col, m), n = Math.max(j.col, n));
        ...
        function I(b, c) {
            if (a(b).is(c))D(), a(b).addClass("fr-selected-cell"); else {
                E();
                var d = A(), e = B(b, d), f = B(c, d), g = G(Math.min(e.row, f.row), Math.max(e.row, f.row), Math.min(e.col, f.col), Math.max(e.col, f.col), d);
                D();
                for (var h = g.min_i; h <= g.max_i; h++)for (var i = g.min_j; i <= g.max_j; i++)a(d[h][i]).addClass("fr-selected-cell")
            }
        }
        ...
        function L(c) {
            if (1 == c.which) {
                ...
                } else b.$tb.is(c.target) || b.$tb.is(a(c.target).closest(b.$tb.get(0))) || D();
                if (ba) {
        ...
        function M(c) {
            if ($ === !0) {
                ...
                if (d.closest("table").is(b.$el.find(".fr-selected-cell").closest("table"))) {
                    if ("TD" == c.currentTarget.tagName && 0 === b.$el.find("th.fr-selected-cell").length)return void I(_, c.currentTarget);
                    if ("TH" == c.currentTarget.tagName && 0 === b.$el.find("td.fr-selected-cell").length)return void I(_, c.currentTarget)
                }
                E()
            }
        }
        ...
        function P(c) {
            ...
            if (d && "TD" != d.tagName && "TH" != d.tagName && (e.closest("td").length > 0 ? d = e.closest("td") : e.closest("th").length > 0 && (d = e.closest("th"))), d && ("TD" == d.tagName || "TH" == d.tagName)) {
                ...
                if (Math.abs(c.pageX - f) <= b.opts.tableResizerOffset || Math.abs(g - c.pageX) <= b.opts.tableResizerOffset) {
                    ...
                    if (c.pageX - f <= b.opts.tableResizerOffset)if (j = f, n.col > 0 && m[n.row][n.col - 1]) {
                    ...
                    } else h = null, i = n.col, k = p.parent().offset().left + parseFloat(p.parent().css("padding-left")), l = p.offset().left - 1 + p.outerWidth() - m[0].length * b.opts.tableResizingLimit; else if (g - c.pageX <= b.opts.tableResizerOffset)if (j = g, o.col < m[o.row].length && m[o.row][o.col + 1]) {
        ...
        function T(a, b, c) {
            var d, e = 0;
            for (d = a; b >= d; d++)e += S(d, c);
            return e
        }

        function U(a) {
            if ($ === !1 && ba === !1)aa && clearTimeout(aa), aa = setTimeout(P, 30, a); else if (ba) {
        ...
        function W(c) {
            ...
            if (d == a.FroalaEditor.KEYCODE.TAB && 0 === b.opts.tabSpaces) {
                var e;
                if (b.$el.find(".fr-selected-cell").length > 0)e = b.$el.find(".fr-selected-cell:last"); else {
        ...
        function X() {
            return b.$wp ? (b.helpers.isMobile() || ($ = !1, ba = !1, O(), b.$el.on("mousedown.table" + b.id, K), b.popups.onShow("image.edit", function () {
                ...
                if (b.$el.find(".fr-selected-cell").length > 0) {
                    if (c.which == a.FroalaEditor.KEYCODE.ESC)return D(), c.preventDefault(), c.stopPropagation(), c.stopImmediatePropagation(), !1;
                    if (c.which == a.FroalaEditor.KEYCODE.BACKSPACE)return c.preventDefault(), !1;
    ...
    }, a.FroalaEditor.DefineIcon("insertTable", {NAME: "table"}), a.FroalaEditor.RegisterCommand("insertTable", {
        title: "Insert Table",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
    ...
    }), a.FroalaEditor.DefineIcon("tableHeader", {NAME: "header"}), a.FroalaEditor.RegisterCommand("tableHeader", {
        title: "Table Header",
        focus: !1,
        callback: function () {
    ...
    }), a.FroalaEditor.DefineIcon("tableRows", {NAME: "bars"}), a.FroalaEditor.RegisterCommand("tableRows", {
        type: "dropdown",
        focus: !1,
        title: "Row",
    ...
    }), a.FroalaEditor.DefineIcon("tableColumns", {NAME: "bars fa-rotate-90"}), a.FroalaEditor.RegisterCommand("tableColumns", {
        type: "dropdown",
        focus: !1,
        title: "Column",
    ...
    }), a.FroalaEditor.DefineIcon("tableCells", {NAME: "square-o"}), a.FroalaEditor.RegisterCommand("tableCells", {
        type: "dropdown",
        focus: !1,
        title: "Cell",
    ...
    }), a.FroalaEditor.DefineIcon("tableCellBackground", {NAME: "tint"}), a.FroalaEditor.RegisterCommand("tableCellBackground", {
    ...
    }), a.FroalaEditor.DefineIcon("tableBack", {NAME: "arrow-left"}), a.FroalaEditor.RegisterCommand("tableBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), a.FroalaEditor.DefineIcon("tableVerticalAlign", {NAME: "arrows-v"}), a.FroalaEditor.RegisterCommand("tableVerticalAlign", {
        type: "dropdown",
        focus: !1,
        ...
        html: function () {
            ...
            for (var d in c)b += '<li><a class="fr-command" data-cmd="tableVerticalAlign" data-param1="' + d.toLowerCase() + '" title="' + this.language.translate(c[d]) + '">' + this.language.translate(d) + "</a></li>";
            return b += "</ul>"
        },
        callback: function (a, b) {
    ...
    }), a.FroalaEditor.DefineIcon("tableCellStyle", {NAME: "magic"}), a.FroalaEditor.RegisterCommand("tableCellStyle", {
        title: "Cell Style",
        type: "dropdown",
        focus: !1,
        html: function () {
            var a = '<ul class="fr-dropdown-list">', b = this.opts.tableCellStyles;
            for (var c in b)a += '<li><a class="fr-command" data-cmd="tableCellStyle" data-param1="' + c + '" title="' + b[c] + '">' + b[c] + "</a></li>";
            return a += "</ul>"
        },
        callback: function (a, b) {
