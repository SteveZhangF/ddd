...
!function (a) {
    ...
    a.FroalaEditor.PLUGINS.align = function (b) {
        ...
        function e(c) {
            ...
            if (e.length) {
                var f = d(a(e[0]));
                c.find("> *:first").replaceWith(b.icon.create("align-" + f))
            }
        }
