    ...
    window.jsPlumbAdapter = {
        ...
        setRenderMode: function (mode) {
            ...
            if (mode) {
                ...
                // now configuration we actually have the capability to do this.
                if (mode === "svg") {
...
(function () {
    ...
    // TODO support insert index
        ...
        /**
         ...
         i was originally using "a.constructor == Array" as a configuration.
         */
    ...
    var jsPlumbInstance = function (_defaults) {
         ...
         */
            _prepareConnectionParams = function (params, referenceParams) {
                ...
                // configuration for endpoint uuids to connect
                if (params.uuids) {
            ...
            _setVisible = function (el, state, alsoChangeEndpoints) {
                ...
                _operation(id, function (jpc) {
                    if (state && alsoChangeEndpoints) {
                        // this configuration is necessary because this functionality is new, and i wanted to maintain backwards compatibility.
...
// --------------------------- jsPLumbInstance public API ---------------------------------------------------------
        ...
        this.detach = function () {
            ...
            if (conn) {
                ...
                // configuration for endpoint uuids to detach
                if (_p.uuids) {
        ...
        /**
         * gets some configuration hooks. nothing writable.
         */
...
(function () {
    ...
    var Line = function (x1, y1, x2, y2) {
            ...
            this.rectIntersect = function (x, y, w, h) {
                ...
                // configuration that the X value is in the line's range.
            ...
            this.paint = function (style) {
                if (style !== null) {
                    ...
                    if (self.canvas == null) {
                        ...
                        //var group = _getGroup(params.parent);                   // configuration of append everything to a group
