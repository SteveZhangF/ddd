!function () {
    ...
    var a = !!window.SVGAngle || document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"), b = function () {
        if (void 0 === b.vml) {
    ...
    }, e = ["click", "dblclick", "mouseenter", "mouseout", "mousemove", "mousedown", "mouseup", "contextmenu"], f = {
        mouseout: "mouseleave",
    ...
    var q = 0, r = function () {
        ...
        var n = null, o = !1, p = [], q = {}, s = {}, u = {}, v = {}, w = {}, x = {}, y = !1, z = [], A = !1, B = null, C = this.Defaults.Scope, D = null, E = 1, F = function () {
            return "" + E++
        }, G = function (a, b) {
            ...
            if (!jsPlumbAdapter.headless) {
                ...
                if (f && t.isDragSupported(b, e) && !t.isAlreadyDraggable(b, e)) {
                    ...
                    g[j] = a.wrap(g[j], function () {
                        ...
                        I(b, a), e.removeClass(b, "jsPlumb_dragged"), e.setHoverSuspended(!1), e.select({source: b}).removeClass(e.elementDraggingClass + " " + e.sourceElementDraggingClass, !0), e.select({target: b}).removeClass(e.elementDraggingClass + " " + e.targetElementDraggingClass, !0), e.setConnectionBeingDragged(!1), e.dragManager.dragEnded(b)
                    });
                    var k = Y(b);
                    x[k] = !0;
                    var l = x[k];
        ...
        this.setConnectionBeingDragged = function (a) {
            ...
            for (var g = [], h = a.isArray(b) || null != b.length && !a.isString(b) ? b : [b], i = 0, j = h.length; j > i; i++) {
                ...
                var n = u[l], o = z[l], p = m.anchor.compute({
                    xy: [n.left, n.top],
                    wh: o,
                    element: m,
                    timestamp: B
            ...
            d = d || {};
            var f = this.getElementObject(b), g = this.getDOMElement(b), h = Y(g), i = t.animEvents.step, j = t.animEvents.complete;
        ...
        this.unregisterEndpoint = function (a) {
            ...
            if (0 !== arguments.length) {
                var a = e.Defaults.ConnectionType || e.getDefaultConnectionType(), b = arguments[0].constructor == a, c = 2 == arguments.length ? b ? arguments[1] || {} : arguments[0] : arguments[0], d = c.fireEvent !== !1, f = c.forceDetach, g = b ? arguments[0] : c.connection;
            ...
            var b = {
                ...
                endpointCount: 0,
                connectionCount: 0
            }, c = a.fireEvent !== !1, d = a.deleteAttachedObjects !== !1, f = function (a) {
        ...
        this.makeTarget = function (c, d, f) {
            ...
            var h = g.scope || e.Defaults.Scope, i = !(g.deleteEndpointsOnDetach === !1), l = g.maxConnections || -1, m = g.onMaxConnections, n = function (c) {
                ...
                var o = function () {
                    ...
                    var a = this.getDropEvent(arguments), c = this.select({target: e}).length, h = this.getDOMElement(this.getDragObject(arguments)), j = this.getAttribute(h, "dragId"), k = this.getAttribute(h, "originalScope"), l = w[j], n = l.endpoints[0].isFloating() ? 0 : 1, o = l.endpoints[0], p = (g.endpoint ? t.extend({}, g.endpoint) : {}, this.targetEndpointDefinitions[e]);
                    ...
                    if (q) {
                        ...
                        if ((null == u || null == u._jsPlumb) && (u = this.addEndpoint(s, g)), g.uniqueEndpoint && (p.endpoint = u), u._doNotDeleteOnDetach = !1, u._deleteOnDetach = !0, null != u.anchor.positionFinder) {
                            var v = this.getUIPosition(arguments, this.getZoom()), x = b(s, this), y = this.getSize(s), z = u.anchor.positionFinder(v, x, y, u.anchor.constructorParams);
        ...
        this.registerListener = function (a, b, c) {
            ...
            var e = this.getConnections({source: d, scope: "*"}, !0), f = this.getConnections({
                target: d,
                scope: "*"
            }, !0);
    ...
    jsPlumb.Endpoint = function (g) {
        var h = g._jsPlumb, i = (jsPlumbAdapter.getAttribute, jsPlumb.getElementObject), j = jsPlumbUtil, k = g.newConnection, l = g.newEndpoint, m = g.finaliseConnection, n = (g.fireDetachEvent, g.fireMoveEvent), o = g.floatingConnections;
        ...
        this.initDraggable = function () {
            if (!t && jsPlumb.isDragSupported(this.element)) {
                var d = {id: null, element: null}, e = null, f = !1, m = null, n = a(d, h), q = function () {
                    ...
                    var r = i(p.canvas), s = jsPlumbAdapter.getOffset(r, this._jsPlumb.instance), t = i(this.canvas);
                ...
                }.bind(this), r = g.dragOptions || {}, s = {}, u = jsPlumb.dragEvents.start, v = jsPlumb.dragEvents.stop, w = jsPlumb.dragEvents.drag;
                r = jsPlumb.extend(s, r), r.scope = r.scope || this.scope, r[u] = j.wrap(r[u], q, !1), r[w] = j.wrap(r[w], n.drag), r[v] = j.wrap(r[v], function () {
                    if (h.setConnectionBeingDragged(!1), e && null != e.endpoints) {
                        var a = h.getDropEvent(arguments), b = null == e.floatingAnchorIndex ? 1 : e.floatingAnchorIndex;
        ...
        var u = function (a, b, c, d) {
            if ((this.isTarget || b) && jsPlumb.isDropSupported(this.element)) {
                ...
                var f = jsPlumb.dragEvents.drop, i = jsPlumb.dragEvents.over, k = jsPlumb.dragEvents.out, l = function () {
                    this.removeClass(h.endpointDropAllowedClass), this.removeClass(h.endpointDropForbiddenClass);
                    var a = h.getDropEvent(arguments), b = h.getDOMElement(h.getDragObject(arguments)), c = h.getAttribute(b, "dragId"), e = (h.getAttribute(b, "elId"), h.getAttribute(b, "originalScope")), f = o[c];
                    if (null != f) {
                ...
                e[f] = j.wrap(e[f], l), e[i] = j.wrap(e[i], function () {
                    var a = jsPlumb.getDragObject(arguments), b = h.getAttribute(jsPlumb.getDOMElement(a), "dragId"), c = o[b];
                    if (null != c) {
                    ...
                    var a = jsPlumb.getDragObject(arguments), b = null == a ? null : h.getAttribute(jsPlumb.getDOMElement(a), "dragId"), c = b ? o[b] : null;
                    if (null != c) {
                        var d = null == c.floatingAnchorIndex ? 1 : c.floatingAnchorIndex, e = this.isTarget && 0 !== c.floatingAnchorIndex || c.suspendedEndpoint && this.referenceEndpoint && this.referenceEndpoint.id == c.suspendedEndpoint.id;
            ...
            if (!this._jsPlumb.instance.isSuspendDrawing() && this._jsPlumb.visible) {
                ...
                if (null == d || d != this._jsPlumb.lastPaintedAt) {
                    var j = this._jsPlumb.instance.updateOffset({
                        ...
                        recalc: c,
                        timestamp: d
                    }).o, k = this._jsPlumb.instance.updateOffset({
                        elId: f,
                        timestamp: d
                    }).o, l = this.endpoints[i], m = this.endpoints[h];
                    ...
                    var s = parseFloat(this._jsPlumb.paintStyleInUse.lineWidth || 1) / 2, t = parseFloat(this._jsPlumb.paintStyleInUse.lineWidth || 0), u = {
    ...
    jsPlumb.AnchorManager = function (a) {
        ...
        var u = function (b, c, d, e, f, g, h, i, j, k, l, m) {
            var n = -1, o = -1, p = e.endpoints[h], q = p.id, r = [1, 0][h], s = [[c, d], e, f, g, q], t = b[j], u = p._continuousAnchorEdge ? b[p._continuousAnchorEdge] : null;
            if (u) {
        ...
        this.updateOtherEndpoint = function (a, b, c, d) {
            ...
            if (!k.isSuspendDrawing()) {
                ...
                for (v = 0; v < i.length; v++)i[v].paint({timestamp: d, offset: r, dimensions: r.s, recalc: g !== !0});
        ...
        this.computeMaxSize = function () {
            ...
            if (a.pointAlongPathFrom) {
                ...
                var q = {
                    ...
                    tail: k,
                    cxy: l
                }, r = f.strokeStyle || d.strokeStyle, s = f.fillStyle || d.strokeStyle, t = f.lineWidth || d.lineWidth, u = {
                    component: a,
                    d: q,
                    lineWidth: t,
                    strokeStyle: r,
        ...
        var b, c = jsPlumb.Connectors.AbstractConnector.apply(this, arguments), d = null == a.midpoint ? .5 : a.midpoint, e = [], f = (a.grid, a.alwaysRespectStubs), g = null, h = null, i = null, j = null != a.cornerRadius ? a.cornerRadius : 0, k = function (a) {
            ...
            for (var e, f, g = 0; g < b.length - 1; g++) {
                if (e = e || n(b[g]), f = n(b[g + 1]), j > 0 && e[4] != f[4]) {
                    ...
                    c.addSegment(a, "Straight", {x1: e[0], y1: e[1], x2: e[2], y2: e[3]}), c.addSegment(a, "Arc", {
                        r: h,
                        x1: e[2],
                        y1: e[3],
                        x2: f[0],
    ...
    var n = jsPlumb.ConnectorRenderers.vml = function (b) {
        ...
        this.paint = function (d) {
            if (null !== d) {
                ...
                if (d.outlineColor) {
                    var n = d.outlineWidth || 1, o = d.lineWidth + 2 * n, p = {
