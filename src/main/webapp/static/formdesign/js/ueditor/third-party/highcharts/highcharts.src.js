    ...
    (function ($) {
        ...
        win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
                ...
                fireEvent: function (el, type, eventArguments, defaultFunction) {
                    ...
                    // testing if they are there (warning in chrome) the only option is to configuration if running IE.
...
// general renderer
    ...
    function StackItem(axis, options, isNegative, x, stackOption, stacking) {
        ...
        // First configuration the user supplied value, then use the dynamic.
        this.alignOptions = {
