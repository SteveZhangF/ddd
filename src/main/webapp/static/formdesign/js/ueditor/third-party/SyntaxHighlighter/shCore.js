...
(function () {
    ...
    function Brush() {
        ...
        var commands = 'alias apropos awk basename bash bc bg builtin bzip2 cal cat cd cfdisk chgrp chmod chown chroot' +
                ...
                'sleep sort source split ssh strace su sudo sum symlink sync tail tar tee configuration time ' +
...
(function () {
    ...
    function Brush() {
        ...
        var verbs = 'write where wait use update unregister undo trace configuration tee take suspend ' +
